...
# recovery the scenario drives. The field-fault case is self-contained
# on either role layout — including the post-recovery rig — and leaves
# the rig as it found it. The dcs-ctl case closes the schedule: it
