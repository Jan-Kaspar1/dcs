...
# and promotes the converged one back. The plant-link-loss case
...
# drives. The field-fault case closes the schedule: it is
# self-contained on either role layout — including the post-recovery
# rig — and leaves the rig as it found it.
