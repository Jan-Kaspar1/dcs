...
//! `second_order_lag`, `integrator`, `dead_time`, `noise`) standing in
//! for field physics. The document is kept out
...
(SIGINT/SIGTERM).
  ...
  --dynamics FILE  merge a JSON list of process-element declarations —
                   ...
                   dead_time, noise — into the simulated plant; process
                   physics are simulation internals, not part of the
                   model contract
