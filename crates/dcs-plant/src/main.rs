...
//! [`ProcessElement`] declarations (`first_order_lag`, `integrator`,
//! `dead_time`) standing in for field physics. The document is kept out
...
(SIGINT/SIGTERM).
  ...
  --dynamics FILE  merge a JSON list of process-element declarations —
                   first_order_lag, integrator, dead_time — into the
