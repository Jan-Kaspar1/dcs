...
| Crate | Layer | Status |
|---|---|---|
| `dcs-core` | Shared contracts: signal (value + quality + tick timestamp), component and logical I/O traits | In progress — signal model (#5) and logical-I/O abstraction (#6) implemented; component traits planned |
