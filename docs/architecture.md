...
- **Status:** Proposed — direction only, recorded as the basis of milestone M3; nothing is implemented. The enabler it relies on is implemented: the executor's virtual-tick determinism (#9) makes transferred state meaningful.
