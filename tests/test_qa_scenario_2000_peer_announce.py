...
class PeerAnnounceTests(unittest.TestCase):
    ...
    def test_registered(self):
        ...
        self.assertEqual(
            ...
            order.index(scenarios.scenario_peer_announce))
        # The forged-standby and stale-island legs share the same
        # restored pre-switch window, then the tune case's a->b
        # switch closes it.
        self.assertEqual(
        ...
        self.assertEqual(
            order.index(
                scenarios.scenario_stale_island_resolution) + 1,
